      ...
      <div className='flex h-5 items-center'>
        ...
        <div className='group flex items-center'>
          ...
          <div className='flex h-8 md:h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500  md:group-focus-within:ml-5 md:group-focus-within:pl-0'>
            ...
            <input
              type='text'
              className='bg-black outline-none text-white pr-5 pl-5 md:pl-0 w-44 md:group-focus-within:pl-0 md:w-64 lg:w-[500px] '
              onChange={(e) => setSearchQuery(e.target.value)}
              onKeyUp={searchQueryHeader}
              value={searchQuery}
            />
          ...
          <button className='w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center boder-l-0 border-[#303030] rounded-r-3xl bg-white/[0.1] '>
            <IoIosSearch className='text-white text-xl' />
...
<div className='flex h-8 w-8 overflow-hidden rounded-[50%] md:ml-4'>
